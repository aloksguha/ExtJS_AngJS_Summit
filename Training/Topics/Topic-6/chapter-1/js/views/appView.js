    ...
    function($, _, Backbone, appTemplate, CourseCollection, CourseModel, CourseView) {
        ...
        var appView = Backbone.View.extend({
            ...
            filter: function(){
                ...
                this.filterCourses(searchStr);
            },

            filterCourses: function(searchStr){
                //filter collection
                this.courses.reset(
            ...
            gridView: function(event){
                ...
                this.$(".grid-view").siblings().removeClass("active");
                this.$(".grid-view").addClass("active");
            },
            ...
            listView: function(event){
                ...
                this.$(".list-view").siblings().removeClass("active");
                this.$(".list-view").addClass("active");
            },

            saveCourse: function(){
                if(this.editCourseModel){  //Edit mode
                    this.editCourseModel.set({
                    ...
                    if (!this.editCourseModel.isValid()) {
